...
replaceitem entity @s[scores={PanelFly=9}] inventory.11 feather{settings:{fly:1b},HideFlags:63,secu:1b,display:{Name:'["",{"text":"Slot Vol Créatif: ","bold":true,"italic":false},{"text":"Tous","bold":true,"italic":false,"color":"aqua"}]'}}
replaceitem entity @s[scores={PanelFly=10}] inventory.11 feather{settings:{fly:1b},HideFlags:63,secu:1b,display:{Name:'["",{"text":"Slot Vol Créatif: ","bold":true,"italic":false},{"text":"Aucun","bold":true,"italic":false,"color":"red"}]'}}

replaceitem entity @s[scores={PanelMsg=0}] inventory.12 flower_banner_pattern{settings:{msg:1b},HideFlags:63,secu:1b,display:{Name:'["",{"text":"Messages: ","bold":true,"italic":false},{"text":"Oui","bold":true,"italic":false,"color":"green"}]'}}
replaceitem entity @s[scores={PanelMsg=1..}] inventory.12 flower_banner_pattern{settings:{msg:1b},HideFlags:63,secu:1b,display:{Name:'["",{"text":"Messages: ","bold":true,"italic":false},{"text":"Non","bold":true,"italic":false,"color":"red"}]'}}
